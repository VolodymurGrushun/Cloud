...
public Collection<Conference> getConferencesToAttend(final User user)
	...
	@ApiMethod(name = "getProfileFromUser", path = "getProfileFromUser", httpMethod = HttpMethod.GET)
    ...
    public Conference createConference(final User user, final ConferenceForm conferenceForm)
        ...
        // TODO (Lesson 4)
                ...
                Profile profile = getProfileFromUser(user);
                if (profile == null) profile = saveProfile(new ProfileForm(null, ProfileForm.TeeShirtSize.NOT_SPECIFIED), user);
